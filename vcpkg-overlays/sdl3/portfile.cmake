vcpkg_from_github(
    ...
    PATCHES
        fix-freebsd.patch
        # Local overlay only: SDL_gtk.c's getresuid()/getresgid() fallbacks collide with glibc's
        # declarations when SDL's configure-time check misses them, which breaks the build on
        # current glibc. Drop this port (and the patch) once upstream sdl3 builds again.
        fix-getresuid-glibc.patch
)
