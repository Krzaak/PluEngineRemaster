...
namespace Plu
{
    ...
    PLUPHYSICS_API DynamicArray<MeshCollisionShapeEntry> BuildCollisionShapesForMesh(StaticMesh* mesh, Vec3 scale = Vec3(1.0f));
    ...
    PLUPHYSICS_API const DynamicArray<MeshCollisionShapeEntry>* GetOrBuildUnscaledCollisionShapesForMesh(
    ...
    PLUPHYSICS_API DynamicArray<MeshCollisionShapeEntry> GetOrBuildCollisionShapesForMesh(
