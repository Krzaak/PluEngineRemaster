...
namespace Plu
{
	...
	PLU_STRUCT(Abstract)
	struct PLUASSETTYPES_API LogicBinaryNode : LogicGraphNode
	{
	...
	PLU_STRUCT()
	struct PLUASSETTYPES_API LogicAndNode : LogicBinaryNode
	{
	...
	PLU_STRUCT()
	struct PLUASSETTYPES_API LogicOrNode : LogicBinaryNode
	{
	...
	PLU_STRUCT()
	struct PLUASSETTYPES_API LogicNotNode : LogicGraphNode
	{
	...
	PLU_STRUCT(Abstract)
	struct PLUASSETTYPES_API LogicCompareNode : LogicGraphNode
	{
	...
	PLU_STRUCT()
	struct PLUASSETTYPES_API LogicGreaterNode : LogicCompareNode
	{
	...
	PLU_STRUCT()
	struct PLUASSETTYPES_API LogicLessNode : LogicCompareNode
	{
	...
	PLU_STRUCT()
	struct PLUASSETTYPES_API LogicEqualNode : LogicCompareNode
	{
	...
	PLU_STRUCT()
	struct PLUASSETTYPES_API LogicSelectNode : LogicGraphNode
	{
