...
namespace Plu
{
    ...
    PLU_STRUCT()
    struct PLUASSETTYPES_API AnimationVectorKey
    {
    ...
    PLU_STRUCT()
    struct PLUASSETTYPES_API AnimationQuatKey
    {
    ...
    PLU_STRUCT()
    struct PLUASSETTYPES_API AnimationTrack
    {
    ...
    PLU_STRUCT()
    struct PLUASSETTYPES_API Animation : IAssetData
    {
