...
namespace Plu
{
	...
	PLU_STRUCT(Abstract)
	struct PLU_API MathBinaryNode : MathGraphNode
	{
	...
	PLU_STRUCT(Abstract)
	struct PLU_API MathUnaryNode : MathGraphNode
	{
	...
	PLU_STRUCT()
	struct PLU_API MathAddNode : MathBinaryNode
	{
	...
	PLU_STRUCT()
	struct PLU_API MathSubtractNode : MathBinaryNode
	{
	...
	PLU_STRUCT()
	struct PLU_API MathMultiplyNode : MathBinaryNode
	{
	...
	PLU_STRUCT()
	struct PLU_API MathDivideNode : MathBinaryNode
	{
	...
	PLU_STRUCT()
	struct PLU_API MathMinNode : MathBinaryNode
	{
	...
	PLU_STRUCT()
	struct PLU_API MathMaxNode : MathBinaryNode
	{
	...
	PLU_STRUCT()
	struct PLU_API MathAbsNode : MathUnaryNode
	{
	...
	PLU_STRUCT()
	struct PLU_API MathNegateNode : MathUnaryNode
	{
	...
	PLU_STRUCT()
	struct PLU_API MathClampNode : MathGraphNode
	{
	...
	PLU_STRUCT()
	struct PLU_API MathLerpNode : MathGraphNode
	{
	...
	PLU_STRUCT()
	struct PLU_API MathConstantNode : MathGraphNode
	{
