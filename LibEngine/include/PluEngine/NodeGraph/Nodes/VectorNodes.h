...
namespace Plu
{
	...
	PLU_STRUCT()
	struct PLU_API VectorScaleNode : VectorGraphNode
	{
	...
	PLU_STRUCT()
	struct PLU_API VectorLengthNode : VectorGraphNode
	{
	...
	PLU_STRUCT()
	struct PLU_API VectorNormalizeNode : VectorGraphNode
	{
	...
	PLU_STRUCT()
	struct PLU_API VectorDotNode : VectorGraphNode
	{
	...
	PLU_STRUCT()
	struct PLU_API VectorCrossNode : VectorGraphNode
	{
	...
	PLU_STRUCT()
	struct PLU_API VectorDistanceNode : VectorGraphNode
	{
	...
	PLU_STRUCT()
	struct PLU_API VectorMakeNode : VectorGraphNode
	{
	...
	PLU_STRUCT()
	struct PLU_API VectorBreakNode : VectorGraphNode
	{
