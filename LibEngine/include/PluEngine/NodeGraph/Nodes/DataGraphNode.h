...
#include "PluEngine/NodeGraph/GraphValue.h"
...
namespace Plu
{
	...
	PLU_STRUCT(Abstract)
	struct PLU_API DataGraphNode : GraphNode
	{
	...
	PLU_STRUCT(Abstract)
	struct PLU_API MathGraphNode : DataGraphNode
	{
		REFLECTION_BODY_MATHGRAPHNODE()
	};

	PLU_STRUCT(Abstract)
	struct PLU_API VectorGraphNode : DataGraphNode
	{
	...
	PLU_STRUCT(Abstract)
	struct PLU_API LogicGraphNode : DataGraphNode
	{
	...
	PLU_STRUCT(Abstract)
	struct PLU_API ConvertGraphNode : DataGraphNode
	{
