...
namespace Plu
{
    ...
    PLU_API bool BoneRefEditorControl(void* value, const String& name);
    ...
    // current name as-is.
    PLU_API void SetBonePickerSkeleton(Skeleton* skeleton);
    PLU_API Skeleton* GetBonePickerSkeleton();
