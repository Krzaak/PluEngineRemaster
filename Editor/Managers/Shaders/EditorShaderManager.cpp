...
void Plu::EditorShaderManager::AddMaterialToLoad(TUsePointer<EditorAssetObject<MaterialInfo>> material)
{
...
{
	for (TUsePointer<EditorAssetObject<MaterialInfo>>& material : mMaterialsToLoad) {
